...
public:
 ...
 /*\/\/\/\/\/\/\/\/\/\/\/*/
  ...
  void FuseRegions(float, int);
	...
	/*/\/\/\/\/\/\/\/\/\/\*/
	/*/\added by Jianqiao\*/
void SetDepth(float* const pDepth, float fDepthThresh);
void FuseWithDepth(float* const pDepth, float fDepthThresh);
 ...
 /*\/\/\/\/\/\/\/\/\/\/*/
  ...
  void Segment(int, float, int, SpeedUpLevel, bool bDepthAssisted=false);
...
private:
  ...
  //========================
   ...
   void NewOptimizedFilter2(float, float);
	...
	/*/\/\/\/\/\/\/\/\/\/\*/
	/*/\added by Jianqiao\*/
	bool TransitiveClosurebyDepth(float fDepthThresh);
  ...
  //=============================
   ...
   //##########################################
	...
	//###########################################
	//#######	added by jianqiao		 ########
	float *mpDepth;			// depth value for each pixel
	float mfDepthThresh;
